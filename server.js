...
app.post('/api/usuarios', async (req, res) => {
    try {
        ...
        // Validar que tenga el campo deporte
        if (!nuevoUsuario.deporte) {
            return res.status(400).json({ error: 'El campo deporte es requerido' });
        }
...
// POST /api/tablas - Guardar tablas
...
// PUT /api/tablas - Actualizar tablas
...
// DELETE /api/tablas/:tipo/:index - Eliminar tabla
